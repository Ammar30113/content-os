  ...
  try {
    ...
    const { data: post, error: postError } = await supabase
      ...
      .insert({
        ...
        rallio_pillar: content.template_fields.rallio_pillar ?? null,
        primary_goal: content.template_fields.primary_goal ?? null,
        secondary_goal: content.template_fields.secondary_goal ?? null,
        hook: content.hook,
