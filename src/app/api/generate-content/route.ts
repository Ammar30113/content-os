                    ...
                    "If a real reference image URL is supplied, do not invent fake screenshots, logos, portraits, or product images. Use the supplied URL only when it makes the visual more concrete.",
	                  ...
	                  rallio_rich_field_guide: isRallio
	                    ? [
	                        ...
	                        "For rallio_receipt: receipt_lines must be an array of short strings where each string is exactly one spot name followed by a dash or em-dash and one number (e.g. ['Bang Bang — 14', 'Bar Isabel — 9', 'Sunline — 6']). Do NOT put neighborhoods, addresses, categories, or descriptions inside receipt_lines — each line is ONLY a short spot name and a number. subtotal must be a plain number string (e.g. '29'), never a word, phrase, or sentence. launch_neighborhood should be the neighborhood context for the receipt header.",
